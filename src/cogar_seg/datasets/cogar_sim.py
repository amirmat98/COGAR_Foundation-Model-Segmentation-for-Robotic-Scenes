...
def normalize_cogar_sim_500(
    raw_coco_dir: str | Path = (
        "data/cogar_sim_500/raw_blenderproc/pilot_v2_ocid_like/coco_data"
    ),
    raw_metadata_path: str | Path = "data/cogar_sim_500/metadata/frame_index_pilot_v2.csv",
    output_root: str | Path = "data/cogar_sim_500",
    config_path: str | Path = "configs/blenderproc_dataset.yaml",
    expected_images: int = 500,
    clean_rgb_dir: bool = True,
) -> NormalizedCogarSim500:
    """Normalize raw BlenderProc COCO output into the COGAR-Sim 500 layout."""
