...
GENERATOR_VERSION = "task123_blenderproc_v1"
...
def build_random_scene(image_id, categories, render_samples, seed):
    ...
    metadata = {
        ...
        "scene_id": f"blenderproc_scene_{image_id:03d}",
        "scene_family": family,
...
def reset_registered_outputs() -> None:
    """Clear BlenderProc renderer outputs between independent one-frame scenes."""
...
def generate_cogar_sim(
    ...
    """Generate randomized BlenderProc scenes for the COGAR-SimRobotics pipeline."""
    ...
    print(f"[OK] BlenderProc raw output: {raw_output_dir}")
